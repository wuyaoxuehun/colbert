...
from corpus_cb import load_all_paras_geo
...
from colbert.training.losses import BiEncoderNllLoss, listMLE, lambdaLoss, listMLEWeighted, listnet_loss
...
query_maxlen = 256
# query_maxlen = 160
# answer_max_seqlen = 16
# doc_maxlen = 384
doc_maxlen = 320
# doc_maxlen = 512

# faiss_depth, nprobe = 256, 128
faiss_depth, nprobe = 1000, 32
# 256, 128
index_config = {
...
fold = 1
train_task = f"colbert0-train-{fold}"
dev_task = f"colbert0-dev-{fold}"
test_task = f"colbert0-dev-{fold}"
# test_task = f"rougelr-test-{fold}"
# dstype = "test"
# test_task = f"rougelr-{dstype}-0"
# save_result_file = f"data/bm25/sorted/{dstype}_0_colbert0.json"
save_result_file = f"data/bm25/sorted/temp.json"
...
use_word = True
l2norm = True
query_max_span_length = 180
doc_max_span_length = 210
