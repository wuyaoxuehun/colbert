...
from colbert.training.training_utils import SequentialDistributedSampler, split_parameters, MAverage, distributed_concat, get_t5_optimizer
...
def train(args):
    train_set_seed(12345, args.rank)
    ...
    train_dataloader = DataLoader(dataset=train_dataset,
                                  ...
                                  batch_size=args.batch_size, collate_fn=collate_fun(), num_workers=4)
    ...
    for epoch in tqdm(range(args.epoch)):
        ...
        # logger.info(model.module.span_len_embedding)
...
def eval_retrieval(args, colbert_qa=None):
    ...
    train_dataloader = DataLoader(dataset=train_dataset,
                                  ...
                                  batch_size=int(args.batch_size * 1.5), collate_fn=collate_fun())
    model = colbert_qa
