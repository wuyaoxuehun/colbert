...
class Arguments():
    ...
    def add_model_parameters(self):
        ...
        self.add_argument('--query_maxlen', dest='query_maxlen', default=320, type=int)
        self.add_argument('--doc_maxlen', dest='doc_maxlen', default=320, type=int)
    ...
    def add_model_training_parameters(self):
        ...
        self.add_argument('--epoch', dest='epoch', default=10, type=int)
        self.add_argument('--mask_q', dest='mask_q', default=1, type=int)
    ...
    def add_index_model_input(self):
        self.add_argument('--collection', dest='collection', required=True)
        self.add_argument('--amp', dest='amp', default=False, action='store_true')
        self.add_argument('--bsize', dest='bsize', default=32, type=int)
        self.add_argument('--checkpoint', dest='checkpoint', required=True)
        self.add_argument('--sample', dest='sample', default=None, type=float)
        self.add_argument('--slices', dest='slices', default=1, type=int)
        self.add_argument('--partitions', dest='partitions', default=None, type=int)
        self.add_argument('--index_path', default=None, type=str)
        self.add_argument('--chunksize', dest='chunksize', default=100.0, required=False, type=float)  # in GiBs
