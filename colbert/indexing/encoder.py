...
class CollectionEncoder():
    def __init__(self, args, process_idx, num_processes, model=None):
        ...
        self.iterator = self._initialize_iterator(overwrite=overwrite_mask_cache)
    ...
    def _load_model(self, model=None):
        ...
        self.inference = ModelInference(self.colbert, amp=self.args.amp, segmenter=segmenter)
    ...
    def encode_simple(self):
        ...
        output_path = os.path.join(self.args.index_path, "{}.pt".format(0))
        output_sample_path = os.path.join(self.args.index_path, "{}.sample".format(0))
        doclens_path = os.path.join(self.args.index_path, 'doclens.{}.json'.format(0))
