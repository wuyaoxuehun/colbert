...
from colbert.indexing.myfaiss import get_faiss_index_name
...
def main():
    ...
    parser.add_argument('--retrieval_output_file', dest='retrieval_output_file', default='ranking.tsv', type=str, required=True)
